class SolarSystem {
    ...
    static double diameterInMillionKm = 287.46; 
    static double distanceFromCenterOfGalaxyLightYears = 27000;
    static double orbitalSpeedKmPerSec = 828000; 
    static boolean hasAsteroidBelt = true;
    static int numberOfAsteroidsInBelt = 1000000; 
    static boolean hasKuiperBelt = true;
    static boolean hasOortCloud = true;
    static double averageDistanceFromSunAU = 1.0; 
    static String galaxyName = "Milky Way";
    static double massOfSunInKg = 1.98930;
    static double totalMassOfPlanetsInKg = 2.67;
    static String dominantGasInSun = "Hydrogen";
    static double lightTravelTimeFromSunToEarthMinutes = 8.3;
